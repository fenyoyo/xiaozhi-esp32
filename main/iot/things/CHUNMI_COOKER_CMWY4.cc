...
#define TAG "CHUNMI_COOKER_CMWY4"

namespace iot
{
    // 米家智能微压IH电饭煲4L
    // https://home.miot-spec.com/spec/chunmi.cooker.cmwy4
    class CHUNMI_COOKER_CMWY4 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        CHUNMI_COOKER_CMWY4() : Thing("米家智能小饭煲", "")
        {
            Register();
...
DECLARE_THING(CHUNMI_COOKER_CMWY4);
