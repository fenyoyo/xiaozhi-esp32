...
#define TAG "DREAME_VACUUM_P2140"

namespace iot
{
    // 米家扫拖机器人2C
    // https://home.miot-spec.com/spec/dreame.vacuum.p2140
    class DREAME_VACUUM_P2140 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        DREAME_VACUUM_P2140() : Thing("米家扫拖机器人2C", "")
        {
            Register();
        }
...
DECLARE_THING(DREAME_VACUUM_P2140);