...
#define TAG "XIAOMI_LIGHT_LAMP32"

namespace iot
{
    // 米家台灯
    // https://home.miot-spec.com/spec/xiaomi.light.lamp32
    class XIAOMI_LIGHT_LAMP32 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
        ...
        std::map<std::string, SpecAction> miotSpecAction = {
            ...
            {
                "light:brightness-up",
                {2, 2, "setBrightnessUp", "调高亮度 Up", {SpecActionParam(16, "value16", "0-30", kValueTypeNumber)}},
            },
    ...
    public:
        XIAOMI_LIGHT_LAMP32() : Thing("米家台灯", "")
        {
            Register();
        }
...
DECLARE_THING(XIAOMI_LIGHT_LAMP32);
