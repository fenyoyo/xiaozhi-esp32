...
#define TAG "LINP_SWITCH_Q31"

namespace iot
{
    // 领普墙壁开关（单键）
    // https://home.miot-spec.com/spec/linp.switch.q31
    class LINP_SWITCH_Q31 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        LINP_SWITCH_Q31() : Thing("领普墙壁开关（单键）", "")
        {
            Register();
        }
