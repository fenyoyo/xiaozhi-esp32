...
#define TAG "DREAME_VACUUM_P2114A"

namespace iot
{
    // Xiaomi Robot Vacuum X10+
    // https://home.miot-spec.com/spec/dreame.vacuum.p2114a
    class DREAME_VACUUM_P2114A : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        DREAME_VACUUM_P2114A() : Thing("Xiaomi Robot Vacuum X10+", "")
        {
            Register();
        }
...
DECLARE_THING(DREAME_VACUUM_P2114A);