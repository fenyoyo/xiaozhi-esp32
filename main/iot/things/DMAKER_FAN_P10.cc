...
#define TAG "DMAKER_FAN_P10"

namespace iot
{
    // 米家直流变频落地扇2
    // https://home.miot-spec.com/spec/dmaker.fan.p10
    class DMAKER_FAN_P10 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
        ...
        std::map<std::string, SpecProperty> miotSpec = {
            ...
            {
                "fan:mode",
                {2, 3, "模式", "", kValueTypeNumber, Permission::READ | Permission::WRITE, "setMode", "风扇模式:0=直吹模式,1=自然模式"},
            },

            {
                "fan:horizontal-swing",
                {2, 4, "是否开启扫风", "", kValueTypeBoolean, Permission::READ | Permission::WRITE, "setHorizontalSwing", "设置是否开启扫风"},
            },

            {
                "fan:alarm",
                {2, 8, "提示音是否打开", "", kValueTypeBoolean, Permission::READ | Permission::WRITE, "setAlarm", "设置提示音是否打开"},
            },
    ...
    public:
        DMAKER_FAN_P10() : Thing("米家直流变频落地扇2", "")
        {
            Register();
        }
