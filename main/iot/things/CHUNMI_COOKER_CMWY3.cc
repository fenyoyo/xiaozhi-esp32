...
#define TAG "CHUNMI_COOKER_CMWY3"

namespace iot
{
    // 米家智能微压IH电饭煲3L
    // https://home.miot-spec.com/spec/chunmi.cooker.cmwy3
    class CHUNMI_COOKER_CMWY3 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        CHUNMI_COOKER_CMWY3() : Thing("米家智能小饭煲", "")
        {
            Register();
...
DECLARE_THING(CHUNMI_COOKER_CMWY3);
