...
#define TAG "DREAME_VACUUM_R2211O"

namespace iot
{
    // Xiaomi Robot Vacuum S10+
    // https://home.miot-spec.com/spec/dreame.vacuum.r2211o
    class DREAME_VACUUM_R2211O : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
        DREAME_VACUUM_R2211O() : Thing("Xiaomi Robot Vacuum S10+", "")
        {
            Register();
        }
...
DECLARE_THING(DREAME_VACUUM_R2211O);