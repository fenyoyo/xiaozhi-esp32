...
#define TAG "CHUNMI_COOKER_WY3"

namespace iot
{
    // 米家智能电饭煲 3L
    // https://home.miot-spec.com/spec/chunmi.cooker.wy3
    class CHUNMI_COOKER_WY3 : public Thing
    {
    private:
        std::string ip_;
        std::string token_;
    ...
    public:
    CHUNMI_COOKER_WY3() : Thing("米家智能小饭煲", "")
        {
            Register();
...
DECLARE_THING(CHUNMI_COOKER_WY3);
